# -*- coding: UTF-8 -*-
# Author: KingRenjazu
# Team: Darknet Indonesian Brother Hood
...
#    print m+"+--------------------------------------+"
    os.system("echo '|  Author: KingRenjazu   ' | lolcat")
    os.system("echo '|  Team: Darknet Indonesian Brother Hood' | lolcat")
    os.system("echo '|  Instagram: @king_renjazu' | lolcat")
    os.system("echo '|  YouTube: Termux Tutorial  ' | lolcat")
    print m+"+------------------------------------------------+ "
    ...
    print " "
    print m+"   [\033[93m5\033[91m] \033[97mInstall Paketnya Dulu Bro..!"
    print m+"+------------------------------------------------+ "
def pilih():
  try:
 
    print k+"╭────\033[92m[ \033[96mPilih Opsinya.! \033[92m]"
...
def eyes_lolcat():
    ...
    os.system("toilet -f standard 'Eyes Lolcat' | lolcat")
    os.system("echo '             Powered By: Renjazu' | lolcat ")
    print ' '
